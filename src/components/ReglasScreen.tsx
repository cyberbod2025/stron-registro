    ...
    >
      ...
      <div className="text-center mb-10">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-[#F20F72] to-[#8E2DE2] mb-4 shadow-[0_0_30px_rgba(242,15,114,0.3)]"
        >
          <span className="text-2xl">💪</span>
        </motion.div>
        <h1 className="text-2xl font-black italic text-white uppercase tracking-tight">
          Compromiso{" "}
          <span className="text-[#C93CFF]">STRONG</span>
          {" "}💪
        </h1>
      </div>
      ...
      <div className="space-y-4 mb-10">
        {rules.map((rule, index) => (
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#F20F72]/10 border border-[#F20F72]/20 flex items-center justify-center shrink-0 mt-0.5">
              <span className="material-symbols-outlined text-[#F20F72] text-xl">{rule.icon}</span>
            </div>
            <p className="text-sm text-[#e2bdc6] leading-relaxed pt-2">
              {rule.text}{" "}
              <strong className="text-[#F20F72] font-extrabold">{rule.highlight}</strong>
              {rule.suffix}
            </p>
          </motion.div>
        ))}
      ...
      <motion.div
        ...
        className="text-center p-6 rounded-2xl bg-gradient-to-br from-[#F20F72]/10 to-purple-900/10 border border-[#F20F72]/20"
      >
